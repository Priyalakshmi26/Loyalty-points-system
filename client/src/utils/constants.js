...
export const contractAddress = '0x98168Bdb077589010905C3C86A96feb6020d3683' //This can be changed if website wants to connect to the local network, currently it is set to smart contract's deployd on global network 
